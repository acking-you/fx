...
pub const model_context =
    ...
    "Do not attempt curl, wget, package managers, raw sockets, or equivalent network workarounds through shell commands. " ++
    ...
    "This host does not advertise model-facing shell tools.";
