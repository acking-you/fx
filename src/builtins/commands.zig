...
pub const slash_specs = [_]SlashSpec{
    ...
    .{ .kind = .bash_first, .command = "/bash-first", .help_entry = "/bash-first [on|off]", .completion_description = "prefer shell and rg for workspace search", .presentation_category = .model, .has_args = true, .accepts_payload = true },
